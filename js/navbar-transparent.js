...
$(document).ready(function () {
    ...
    if (startchange.length) {
        $(document).scroll(function () {
            scroll_start = $(this).scrollTop();
            if (scroll_start > offset.top) {
                $('.fa-stethoscope').css('color', '#143143');
...
$(document).ready(function () {
    ...
    if (startchange.length) {
        $(document).scroll(function () {
            scroll_start = $(this).scrollTop();
            if (scroll_start > offset.top) {
                $('.fa-hospital-o').css('color', '#143143');
